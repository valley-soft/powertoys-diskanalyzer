...
- **Startup Crash Fix (Hotfix)**: Embedded the Windows App SDK runtime directly into the application package (100% self-contained), eliminating startup crashes on clean Windows installations without requiring external framework package provisioning.
