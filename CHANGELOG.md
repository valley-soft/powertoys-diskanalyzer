...
- **Command Palette Per-Command Toggle**: Implemented granular per-command activation toggles enabling or disabling each of the 3 top-level commands independently.
